...
class CameraViewer(Node):
    ...
    # Dikdörtgen rota için Gazebo PATH ayarları.
    ...
    def __init__(self):
        ...
        # Pencere merkezinden başlayan beş hedefli dikdörtgen rota.
        # Başlangıç merkezi (0.50, 0.50) kontrol algoritmasında örtük olarak
        # kabul edilir. Rota: alt orta -> alt sol -> üst sol ->
        # üst sağ -> alt sağ.
        self.path_uv = [
            (0.50, 0.82),  # 1: alt orta
            (0.22, 0.82),  # 2: alt sol
            (0.22, 0.18),  # 3: üst sol
            (0.78, 0.18),  # 4: üst sağ
            (0.78, 0.82),  # 5: alt sağ
        ...
        self.get_logger().info(
            'Camera viewer started: V14 5-point rectangle segment control, center 20x15 px'
        )
        self.get_logger().info(
