...
# Aktif PATH hedefinin tamamlanması için yatay ve düşey piksel hatalarının
# tolerans içerisinde 0,50 saniye boyunca kesintisiz kalması gerekir.
# Merkezleme aşamasında bekleme süresi kullanılmaz.
PATH_TOLERANCE = 75
PATH_HOLD_TIME = 0.50
...
print(
    "Dikdortgen PATH hedef toleransi:",
    PATH_TOLERANCE,
    "px; hedefte bekleme:",
    PATH_HOLD_TIME,
    "s",
