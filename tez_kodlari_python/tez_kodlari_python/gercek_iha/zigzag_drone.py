...
# Hedefte bekleme süresi kullanılmaz. Zikzak noktaları birbirine yakın olduğu
# için sabit 75 piksel yerine pencere boyutuyla ölçeklenen normalize tolerans
# kullanılır; böylece küçük pencere görüntülerinde hedeflerin atlanması önlenir.
...
print("Zikzak PATH hedef toleransi:", PATH_TOLERANCE_NORM, "normalize")
    ...
    while True:
        ...
        if window_found:
            ...
            if vision_mode == "CENTER":
                ...
                # Zikzak geçişleri birbirine yakın olduğundan hedefe ulaşma
                # kararı normalize pencere koordinatlarında verilir. Bekleme
                # yoktur; toleransa girilen ilk karede sonraki hedefe geçilir.
